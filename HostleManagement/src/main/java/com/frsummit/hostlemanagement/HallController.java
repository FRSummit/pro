...
public class HallController implements Initializable {
    ...
    @FXML
    private TextField noRoomsField;
    @FXML
    private TextField noStdField;
    @FXML
    private TextField addressField;
    @FXML
    private ListView<Hall> listView;
    private ObservableList<Hall> stList;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        stList.addAll(session.createCriteria(Hall.class).list());
        session.close();
    }    
    ...
    private void save(ActionEvent event) {
        ...
        String name = noRoomsField.getText();
        String fn = noStdField.getText();
        String dep = addressField.getText();
        
        Hall s = new Hall(id, name, fn, dep);
        stList.add(s);
