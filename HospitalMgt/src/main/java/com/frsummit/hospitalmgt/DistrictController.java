...
import com.frsummit.hospitalmgt.model.District;
...
public class DistrictController implements Initializable {
    ...
    @FXML
    private ListView<District> listView;
    private ObservableList<District> disList;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        listView.setItems(disList);
        
        Session session = HibernateUtil.getSessionFactory().openSession();
        disList.addAll(session.createCriteria(District.class).list());
        session.close();
        // TODO
    }    
    ...
    private void save(ActionEvent event) {
        ...
        District br = new District(id, name);
        disList.add(br);
