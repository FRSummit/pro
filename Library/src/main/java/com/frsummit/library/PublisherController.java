...
public class PublisherController implements Initializable {
    ...
    @FXML
    private ListView<Publisher> listView;
    private ObservableList<Publisher> stList;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        stList.addAll(session.createCriteria(Publisher.class).list());
        session.close();
    }    
    ...
    private void save(ActionEvent event) {
        ...
        Publisher s = new Publisher(id, name, dep, phone);
        stList.add(s);
